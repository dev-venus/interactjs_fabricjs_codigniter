        ...
        base.init = function(){
            ...
            if (base.links.length > 0){
                ...
                for (var i = 0; i < base.links.length; i++) {
                    ...
                    sub_fab_btns_dom += "<div class='sinn sin_"+i+"'><button "+id_elem+" data-link-title='"+base.links[i].title+"' data-link-href='"+(base.links[i].url?base.links[i].url:"")+"' data-link-target='"+((base.links[i].target)?base.links[i].target:"")+"' class='sub_fab_btn' style='"+bg_color_style+"'><span style='font-size:36px; "+color_style+"'>"+base.links[i].icon+"</span></button></div>";
                    
                };
                sub_fab_btns_dom = "<div class='sub_fab_btns_wrapper'>"+sub_fab_btns_dom+"</div>";
                base.$el.append(sub_fab_btns_dom).prepend(main_btn_dom);
