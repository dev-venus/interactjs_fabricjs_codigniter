...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url();?>src/favicon.ico">
    <title>Banner Maker login</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="login-register" style="background-image:url(<?php echo base_url() ?>assets/images/background/login-register.jpg);">        
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="login-form" action="<?php echo base_url('auth/log'); ?>" method="post">
                    <!-- inserted by sinbad 07/19 -->
                    <div class="form-group login-big text-center">
                        <a href="#"><img alt="" src="<?php echo base_url('assets/images/login-big.png')?>"></a>
                    </div>
                    <!-- -->
                    <!-- <h2 class="box-title m-b-40 text-center">Sign In Banner Maker</h2> -->
                    <!-- modified by sinbad -->
                    <h2 class="box-title m-b-55 text-center">Sign In Banner Maker</h2>
                    <!--    -->
                    <div class="form-group rl-15">
                        <div class="col-xs-12">
                    ...
                    <hr class="sin-login-hr">
                    <div class="form-group text-center m-t-50  rl-15 sin-btn-login">
                        <div class="col-xs-12">
