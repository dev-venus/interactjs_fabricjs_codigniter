    ...
    <div class="row">
        <div class="col-12 m-t-30">
            ...
            <div class="card-columns">
                <div class="card">
                    <img class="card-img-top img-fluid" src="<?php echo base_url() ?>assets/images/big/img6.jpg" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img-top img-fluid" src="<?php echo base_url() ?>assets/images/big/img5.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h4 class="card-title">Card title</h4>
                        <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                ...
                <div class="card">
                    <img class="card-img img-fluid" src="<?php echo base_url() ?>assets/images/big/img4.jpg" alt="Card image">
                </div>
